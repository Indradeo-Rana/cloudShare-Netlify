            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mt-16 space-y-12 lg:space-y-0 lg:grid lg:grid-cols-3 lg:gap-8">
                    {pricingPlans.map((plan, index) => (
                        <div key={index} className={`flex flex-col rounded-lg shadow-lg overflow-hidden ${plan.Highlighted ? 'border-4 border-purple-500 transform scale-105' : 'border border-gray-200'} bg-white`}>
                            <div className={`px-6 py-8 bg-white ${plan.Highlighted ? 'bg-gradient-to-br from-purple-500 to-white' : ''}`}>
                            ...
                            <div className="flex-1 flex flex-col justify-between px-6 pt-6 pb-8 bg-gray-50 space-y-4">
