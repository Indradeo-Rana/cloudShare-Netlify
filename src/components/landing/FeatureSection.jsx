import { FileText, Wallet, ArrowUpCircle, Shield, Share2, CreditCard, Clock } from "lucide-react";
        ...
        <div className="mt-16">
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
                {features.map((feature, index) => (
                    <div key={index} className="pt-5 border-gray-100 rounded-lg shadow-sm hover:shadow-md tansition-shadow duration-300 bg-white">
                        <div className="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                            <div className="div mt-6">
                                ...
                                <p className="mt-2 text-base-gray-500">
                                    {feature.description}
                                </p>
                            </div>
                        </div>
